...
?>
<div id="checkout_page_container_overrule">
<h3><?php _e('Please review your order', 'wpsc'); ?></h3>
<table class="checkout_cart" border=0 cellpadding="0" cellspacing="1">
   <tr class="header">
      <th colspan="2" ><?php _e('Product', 'wpsc'); ?></th>
      <th width="120"><?php _e('Quantity', 'wpsc'); ?></th>
   ...
   <?php endwhile; //Fim da listagem de produtos?>
   </table>
  ...
  <?php if(wpsc_uses_shipping()): ?>
   ...
   <?php do_action('wpsc_before_form_of_shopping_cart'); ?>
	...
	<?php if(!empty($_SESSION['wpsc_checkout_user_error_messages'])): ?>
		...
		?>
	<?php endif; ?>
<br/><br/><!-- Inicio do Form de usuário -->
